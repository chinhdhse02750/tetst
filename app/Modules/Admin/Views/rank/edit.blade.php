                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text"
                                                   ...
                                                   maxlength="255"
                                                   value="{{ !empty($rank->name_jp) ? $rank->name_jp : '' }}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input name="name_en"
                                                   ...
                                                   maxlength="255"
                                                   value="{{ !empty($rank->name_en) ? $rank->name_en : '' }}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input name="amount"
                                                   ...
                                                   maxlength="10"
                                                   min="0"
                                                   value="{{ !empty($rank->amount) ? $rank->amount : 0 }}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input name="priority"
                                                   ...
                                                   maxlength="4"
                                                   min="0"
                                                   value="{{ !empty($rank->priority) ? $rank->priority : 0 }}">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-2">
                                            <input name="color_code"
                                                   ...
                                                   class="form-control"
                                                   type="color"
                                                   value="{{ !empty($rank->color_code) ? $rank->color_code : \App\Helpers\Constants::DEFAULT_COLOR }}">
                                        </div>
                                    </div>
