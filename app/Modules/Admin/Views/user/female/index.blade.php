...
@section('content')
    ...
    <ul class="nav nav-pills pd-nav-pills" id="pills-tab" role="tablist">
        <li class="nav-item">
            <a class="nav-link btn btn-outline {{ active_class(\Request::is('admin/member/male')) }}"
    ...
    <div id="pills-tabContent" class="tab-content reset-tab-content">
        <div class="tab-pane fade show active" id="pills-female" role="tabpanel" aria-labelledby="pills-female-tab">
            ...
            <div class="card pd-lr-20">
                <div class="card-body">
                    <form id="search-form" class="search-reset-form" onsubmit="return false">
                        <input type="hidden" name="type" value="1" id="type-user">
                        @include('user.includes.female.form_search')
                        <div class="form-group">
                            <div class="d-flex justify-content-center">
                                <input type="submit" class="btn btn-primary mr-1 btn-action button-search-user"
                                       id="search-user" value="@lang('users.label.search')"/>
            ...
            <div class="card search-append" id="search-female-append">
                @include('user.includes.female.result_search')
            </div>
        </div>
    </div>
