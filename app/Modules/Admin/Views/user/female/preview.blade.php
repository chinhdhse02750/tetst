                ...
                <div class="container-detail">
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            @if(!empty($member->public_videos))
                                <div class="container-detail__gallery-video container-detail__slide">
                                    <div class="container-detail__slide-title">
                                        ...
                                        <span>{{ $member->name }}</span>@lang('users.label.of_video')
                                    </div>
                                    <!-- Hidden video div -->
                                    @foreach($member->public_videos as $key => $video)
                            ...
                            @endif
                            @if(!empty($member->private_images))
                                <div class="container-detail__gallery-image container-detail__slide">
                                    <div class="container-detail__slide-title">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="16.625"
                                    ...
                                    <ul id="galleryImage" class="gallery-image__container">
                                        @foreach($member->private_images as $image)
                                            <li
                            ...
                            <div class="container-detail__schedule">
                                <div class="container-detail__schedule-title">
                                    <div class="container-detail__schedule-title--primary fs-13px">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="19" height="18.572"
                                             viewBox="0 0 19 18.572">
                                    ...
                                    <div
                                        class="container-detail__schedule-title--sub fs-13px">@lang('users.label.schedule_subtitle')</div>
                                </div>
                                <div
                                    id="memberSchedule"
                                    ...
                                    data-schedules="{{ !empty($member->data_schedules) ? $member->data_schedules : json_encode([]) }}">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="detail__name">
                                <h1>{{ $member->name }}</h1>
                                <span class="detail__about">{!! $member->full_about !!}</span>
                            </div>
                            @if ($member->rating_star)
                                <div class="detail__rate">
                                    <div class="detail__rate-container">
                                        @include('includes.rating', ['rating' => $member->rating_star_calc])
                                    </div>
                                    <a class="js-star-rating js-modal fs-13px" data-target-modal="detail__star-rating-modal"
                            ...
                            <div class="detail__dating-type">
                                <div
                                    class="detail__dating-type--shot-name {{ App::isLocale('en') ? 'en-detail__dating': '' }}">
                                    @lang('users.label.dating_type')
                                    <span class="dating-type__label">{{ $member->dating_type }}</span>
                                </div>
                                <div class="detail__dating-type--container">
                                    <div class="detail__dating-type--title">@lang('users.label.dinner_date') <a
                                            class="js-dating-type js-modal fs-13px"
                                            data-target-modal="detail__dating-type-modal"
                                            href="javascript:void(0)">@lang('users.label.about_dating_type')</a>
                                    </div>
                                    <div
                                        class="detail__dating-type--description fs-13px">@lang('users.label.description_dating_type')</div>
                                </div>
                            ...
                            <div class="detail__profile">
                                ...
                                <div class="detail__profile-container">
                                    <table>
                                        ...
                                        @endif
                                        @if (!empty($member->sign_label))
                                            <tr>
                                                <td>@lang('users.label.sign')：</td>
                                                <td>{{ $member->sign_label }}</td>
                                            </tr>
                                        @endif
                                        ...
                                        @endif
                                        @if (!empty($member->smoking_female_label))
                                            <tr>
                                                <td>@lang('users.label.smoking')：</td>
                                                <td>{{ $member->smoking_female_label }}</td>
                                            </tr>
                                        @endif
                                        @if (!empty($member->alcohol_label))
                                            <tr>
                                                <td>@lang('users.label.alcohol')：</td>
                                                <td>{{ $member->alcohol_label }}</td>
                                            </tr>
                                        @endif
                                    </table>
                                </div>
                            ...
                            @if (!empty($member->club_comment))
                                <div class="detail__comment detail__club-comment">
                                    ...
                                    <div class="detail__comment-container detail__club-comment-container">
                                        {!! html_entity_decode($member->club_comment) !!}
                                    </div>
                                </div>
                            @endif
                        </div>
