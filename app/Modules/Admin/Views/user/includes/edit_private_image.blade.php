<div class="tab-pane fade" id="pills-private-image" role="tabpanel" aria-labelledby="pills-private-image-tab">
    <form id="private-photo-form" action="{{ route('member.update', ['id'=>$user->id, 'type_user'=> $user->type_name]) }}"
          method="POST">
        {{ csrf_field() }}
        @method('PUT')
        <input type="hidden" name="private-image-form" value="yes">
        <div class="card-body">
            ...
            <div class="form-group">
                <div class="d-flex justify-content-center">
                    <input type="submit" class="btn btn-primary mr-1 btn-action"
                           id="change-media" value="@lang('users.label.update')"/>
