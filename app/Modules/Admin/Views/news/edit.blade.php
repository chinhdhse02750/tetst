        ...
        <div class="container-news mt-2">
            <form action="{{ route('news.update', $news->id) }}" method="POST"
                ...
                <div class="form-group row flex-group">
                    ...
                    <div class="col-md-3" id="datetimepicker">
                ...
                <div class="form-group row flex-group">
                    ...
                    <div class="col-md-6">
                        <textarea type="text"
                                  id="news_content"
                                  placeholder="{{__('news.label.content')}}"
                                  name="content"
