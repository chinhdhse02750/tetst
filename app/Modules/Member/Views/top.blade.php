        ...
        <div class="main-container__mix">
            <div class="mix">
                <div class="mix__filter-selected">
                    ...
                    <div
                        class="mix__filter-total-result">{{ __('filters.member.search_result', ['total' => $members->count()]) }} </div>
                </div>
                <div class="mix__order-by">
                    <div class="form-group mix__order-by-group">
                        <label for="selectOrderBy"
                               class="mix__order-by-label d-none d-md-block">@lang('filters.member.sort')</label>
