    ...
    <div class="quickview-box">
        ...
        <div class="row">
            ...
            <div class="col-12 col-md-6"> <span class="shop-detail_info">
                <a class="product-name" href="{{ route('product.detail', ['product' => $products->alias]) }}">{{ $products->name }}</a>
                ...
                <div class="quantity-select"> <label for="quantity">Số lượng:</label>
                    ...
                    <label class="total_product_view"><span
                                class="count_stock">{{ $products->stock }}</span> @lang('product.label.in_stock')</label>
                </div>
                <div
